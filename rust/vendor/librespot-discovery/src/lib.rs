...
#[allow(unused)]
// `Stack=SP` marks this as a Spotify Connect endpoint rather than some
// other stack behind the same service type. Both go-librespot and
// librespot-java advertise it.
const TXT_RECORD: [&str; 3] = ["VERSION=1.0", "CPath=/", "Stack=SP"];
